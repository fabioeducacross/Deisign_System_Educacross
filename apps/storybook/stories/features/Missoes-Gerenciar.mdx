...
<div>
<img 
  src="/Design_System_Educacross/images/missoes/gerenciar-1.png" 
  alt="Coluna 'Ações' na lista de missões mostrando ícones de enviar, editar e excluir"
  style={{
    maxWidth: '800px',
    width: '100%',
    height: 'auto',
...
<div>
<img 
  src="/Design_System_Educacross/images/missoes/gerenciar-2.png" 
  alt="Ícone de enviar (envelope) destacado"
  style={{
    width: '100%',
    height: 'auto',
    border: '1px solid var(--color-neutral-200)',
...
<div>
<img 
  src="/Design_System_Educacross/images/missoes/gerenciar-3.png" 
  alt="Tela de edição de missão com campos para alterar nome, jogos e configurações"
  style={{
    width: '100%',
    height: 'auto',
    border: '1px solid var(--color-neutral-200)',
...
<div>
<img 
  src="/Design_System_Educacross/images/missoes/gerenciar-4.png" 
  alt="Modal de confirmação de exclusão com aviso de ação irreversível"
  style={{
    width: '100%',
    height: 'auto',
    border: '1px solid var(--color-neutral-200)',
...
<div>
<img 
  src="/Design_System_Educacross/images/missoes/gerenciar-5.png" 
  alt="Opção de cancelar missão já enviada"
  style={{
    width: '100%',
    height: 'auto',
    border: '1px solid var(--color-neutral-200)',
...
<div>
<img 
  src="/Design_System_Educacross/images/missoes/gerenciar-6.png" 
  alt="Status de missão cancelada na lista"
  style={{
    width: '100%',
    height: 'auto',
    border: '1px solid var(--color-neutral-200)',
...
```mermaid
flowchart LR
    A[Clicar em Editar] --> B[Fazer alterações]
    B --> C{Salvar?}
    C -->|Sim| D[Missão atualizada]
    C -->|Não| E[Cancelar edição]
    D --> F{Enviar agora?}
    F -->|Sim| G[Disponível para alunos]
    F -->|Não| H[Continua não enviada]
```
...
```mermaid
flowchart TD
    A{Missão foi iniciada?} -->|Não| B[Pode EXCLUIR]
    A -->|Sim| C[Pode apenas CANCELAR]
    B --> D[Missão desaparece]
    C --> E[Missão fica com status 'Cancelada']
