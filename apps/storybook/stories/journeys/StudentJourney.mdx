...
<Section 
  title="🎓 Jornada de Matrícula do Aluno" 
  level="primary"
  description="Fluxo completo de matrícula de um novo aluno na plataforma Educacross"
  spacing="spacious"
>
...
| **Usuário** | Novo aluno (sem conta prévia) |
...
`} 
  caption="Fluxograma da matrícula do aluno com todos os caminhos de decisão"
/>
...
<Section 
  ...
  level="secondary"
  description="Criação de credenciais de acesso para novo aluno"
  spacing="normal"
>
...
<Callout type="warning" title="Pontos de Fricção Identificados">
- **Senha complexa** pode frustrar usuários
- **Validação de CPF** pode falhar por digitação incorreta
- **Email já cadastrado** gera confusão
</Callout>
...
<Section 
  title="2. Validação de Email" 
  level="secondary"
  description="Confirmação de acesso ao email cadastrado"
  spacing="normal"
>
...
<Callout type="info" title="💡 Dica de Implementação">
